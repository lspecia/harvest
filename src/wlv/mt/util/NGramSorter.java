...
/**
 * Processes a language model file
 * The result of this processing will be a new file containing at the top information about the cut-off frequencies in various portions of the language model,
 * followed by those entries in the original file that have the frequency larger than a given threshold
 * 
 * @author cat
 *
 *  
