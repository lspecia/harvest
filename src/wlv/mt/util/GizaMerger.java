...
/**
 * 
 * Transforms a giza translation file where entries represent indeces in a vocabulary into a file where entries are represented by words<br>
 * 
 * Usage:
 * wlv.mt.util.GizaMerger <input file> <source vocabulary> <target vocabulary> <output file> <probability threshold> <br>
 * 
 * The last parameter, <probability threshold>, is optional. If it is used, only those translation with the probability higher than the probability threshold will be included in the output
 * 
 *   
