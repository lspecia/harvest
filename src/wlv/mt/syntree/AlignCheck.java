 ...
 *
 * AlignCheck takes in a folder of Arabic syntactic trees and a folder containing the syntactic trees 
 * of their English translations, and checks each pair of files for number of lines
 * If the number of lines is different in the two files, it prints out the file and the respective number of lines 
 */
