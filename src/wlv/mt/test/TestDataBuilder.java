...
public class TestDataBuilder {
	...
	public void run(){
		try{
			...
			info.write("Indeces file: "+"indeces.txt");info.newLine();info.newLine();
			info.write("Files:");info.newLine();
			...
			for (int i=0;i<nFiles;i++){
				...
				info.write("Input: "+f.getPath());info.newLine();
				info.write("Training (generated): "+folder.getPath()+File.separator+f.getName()+".train");info.newLine();
				info.write("Testing  (generated):"+folder.getPath()+File.separator+f.getName()+".test");info.newLine();
				info.newLine();
			}
	...
	/**
	 * Randomly generates approximately n% line indeces and store them in order in a TreeSet
	 */
