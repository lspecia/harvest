...
public class FeatureSerializer {
	 ...
	 * @param mode boolean value indicating whether the features will be appended to the xml file (true) or if the file will be re-written (false)
	 * Use "false", for example, when all Feature classes are in the same package, or when you are only interested in the Features contained in a certain package<br>
	 * Use "true" in most cases where you have implemented new features in a new package and want to add them to already defined features
	 *   
	 */
