...
/**
 * The FeatureManager controls the loading, instantiation and running of the features. <br>
 * It parses the user-supplied list of feature indeces and uses a FeatureLoader to instantiate the selected features<br>
 * It also provides a method for running the features over a given pair of source-target Sentences 
...
public class FeatureManager {
	...
	/**
	 * instantiates the FeatureManager from a list of feature indeces given as a String and a feature configuration file
	 * @param featureArgs
	 * @param featureFile
	 */
...
//			loadAllFeatures();
	...
	/**
	 * constructs a list of available features by matching features listed in the feature configuration file with those requested by the application
	 */
 ...
 */
	...
	public void parseFeatureArgs(String featureArgs){
		...
		printFeatures();
		}catch (FeatureArgumentException e) {e.printStackTrace();}
	}
