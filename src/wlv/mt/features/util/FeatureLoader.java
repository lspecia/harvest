...
/**
 * A FeatureLoader is responisble for instantiating Feature objects from a list of feature indeces
...
public class FeatureLoader {
	...
	/**
	 * Creates a list of features by inspecting the XML feature configuration file and creating a Feature object from each <feature> node
	 */
