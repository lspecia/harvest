...
/**
 * Models a sentence as a span of text containing multiple information added by pre-processing tools <br>
 * It provides direct access to well used features of a sentence, such as its text, tokens, ngrams, phrases,
 * but also allows any tool to add information related to the sentence via the setValue() method.
 * 
...
public class Sentence {
	...
	/**
	 * 
	 * @return the grammatical structure of the sentence as set by running the Stanford Lexicalised Parser over the sentence
	 */
	...
	public int countChar(char c){
		...
		if (c=='?')
			//we need to escape this to be able to use it in a regular expression
			charS = "\\"+charS;
