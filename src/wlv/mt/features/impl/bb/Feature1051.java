...
/**
 * 
 * average bigram frequency in quartile 2 of frequency (lower frequency words) in the corpus of the source sentence
 * @author Catalina Hallett
 * 
 */

public class Feature1051 extends Feature {
	static int size = 2;
	static int quart = 2;
