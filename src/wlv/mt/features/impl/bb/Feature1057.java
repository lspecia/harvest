...
/**
 * average trigram frequency in quartile 4 of frequency (lower frequency words) in the corpus of the source sentence
 * 
 * @author Catalina Hallett
 * 
 */
public class Feature1057 extends Feature {
	static int size = 3;
	static int quart = 4;
