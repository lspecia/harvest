...
import wlv.mt.tools.WordAlign;
import wlv.mt.util.*;
/**
 * @author Catalina Hallett
 *
 *
 * Dependency feature: number of matched dependencies divided by total number of dependencies (max between source and target)
 */
...
/**
 * number of dependencies with aligned constituents normalized by the total number of dependencies (max between source and target)
 * @author Catalina Hallett
 *   
 *
 */
...
/**
 * Checks whether a given pair of source language words in a dependency relation have aligned correspondents in a list of target dependencies
 * @param  pair
 * @param tdList
