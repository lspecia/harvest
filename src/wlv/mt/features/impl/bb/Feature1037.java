...
/**
 * average number of translations per source word in the sentence (threshold in giza2: prob > 0.01) weighted by the inverse frequency of each word in the source corpus
 * 
