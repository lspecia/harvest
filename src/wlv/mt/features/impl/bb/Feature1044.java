...
/**
 * average number of translations per source word in the sentence (threshold in giza: prob > 0.5) weighted by the inverse frequency of each word in the source corpus
 * @author Catalina Hallett
 * 
 */

public class Feature1044 extends Feature {
