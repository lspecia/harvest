 ...
 * 
 *
 * Average number of translations per source word in the sentence (threshold in giza2: prob > 0.5) weighted by the frequency of each word in the source corpus
 * 
 * @author Catalina Hallett
 */
public class Feature1035 extends Feature {
