...
/**
 * average number of translations per source word in the sentence (threshold in giza2: prob > 0.1) weighted by the frequency of each word in the source corpus
