...
import wlv.mt.features.util.StringOperations;
import wlv.mt.util.*;

/**
 * A FileModel contains information about the input text: the words contained and their frequency in the reference corpus
 * It registers 2 resources: "words" and "freq", required by BB features 20-29
 *
