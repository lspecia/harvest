...
/**
 * A LanguageModel stores information about the ngram content of language model file
 * It provides access to information such as the frequency of ngrams, and the cut-off points for various ngram frequencies
 * @author cat
 */
