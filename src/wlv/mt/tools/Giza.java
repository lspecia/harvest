...
/**
 * This class models the information stored in a giza translation file <br>
...
public class Giza extends Resource {
	...
	/**
	 * stores pairs of <word, int[] probability counts>, where int[i] = the number of translations for the word that have the probability >= PROBS_VALUES[i] 
	 */
	...
	public int loadGiza(String filePath){
		...
		}catch (java.io.IOException e){e.printStackTrace(); return -1;}
		return 0;
	}
...
//		System.out.println(comps[0]+" "+probs);
	...
	/**
	 * Retrieves the probability of a source word being translated as target word
