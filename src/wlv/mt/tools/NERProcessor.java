...
public class NERProcessor {
	...
	/**
	 * Reads in the current sentence from the input file, extracts the relevant named entities (PERSON, ORGANIZATION, LOCATION) and stores their count in the Sentence object passed as parameter
	 *  
	 * @param sent The sentence object which will be enhanced with NE counts as a result of this function 
	 */
